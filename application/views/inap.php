...
<div class="col-md-2 no-padding" style="text-align:right;">
	<a class="btn btn-primary flat" href="<?=base_url();?>inap/baru"><i class="fa fa-plus"></i> TAMBAH DATA</a>
</div>
</div>
</div>
...
<td width="150px">
<a href="<?=base_url();?>inap/edit/<?php echo $data->id_rawatinap; ?>"><i class="fa fa-edit"> EDIT</i></a> | 
<a class="hapus" href="<?=base_url();?>inap/hapus/<?php echo $data->id_rawatinap; ?>"><i class="fa fa-close"> HAPUS</i></a>
</td>
</tr>
<?php
$i++;
