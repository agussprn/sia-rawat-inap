...
<div class="box-body">
	<b><i class="fa fa-user  fa-fw"></i> TAMBAH DATA RAWAT INAP</b>
</div>
</div>
...
<div class="box-body">
<?=$pesan;?>
<form action="<?=base_url();?>inap/baru/simpan" method="post" >
    ...
    <table class="table">
      ...
      <tr>
        ...
        <td scope="col">
        <input name="tgl" type="date" class="form-control" maxlength="15" required style="width:160px;" />
        </td>    
