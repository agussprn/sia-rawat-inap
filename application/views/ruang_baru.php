...
<div class="box-body">
	<b><i class="fa fa-user  fa-fw"></i> TAMBAH DATA RUANGAN RAWAT INAP</b>
</div>
</div>
...
<div class="box-body">
<?=$pesan;?>
<form action="<?=base_url();?>ruang/baru/simpan" method="post" >
    ...
    <table class="table">
	  ...
	  <td width="150px;">Nama Ruangan</td>
        <td>
            <input name="ruang" type="text" class="form-control" maxlength="20" style="width:200px;" required />
        </td>
     </tr>
	 <tr>
        <td>Nama Gedung</td>
        <td>
         <input name="gedung" type="text" class="form-control" maxlength="20" style="width:200px;" required />
        </td>
      </tr>
      <tr>
        <td>Biaya Sewa Perhari</td>
        <td>
         <input name="biaya" type="number" class="form-control" maxlength="11" style="width:200px;" required />
        </td>
      </tr>
